.. only:: html
    ...
    .. raw:: html
        ...
        <blockquote>
        <p>识别给定的物体(object)属于哪个类(category).</p>
        <div class="box-links">
    ...
    .. raw:: html
        ...
        <blockquote>
        <p>将相似的物体(object)自动分组到同一类中.</p>
        <div class="box-links">
        <strong>应用</strong>: 顾客细分, 实验结果归类</br>
        <strong>算法</strong>:&nbsp;
    ...
    :ref:`维数约简<decompositions>`

    .. raw:: html

        </h2>
        <blockquote>
        <p>缩减随机变量(or 特征向量)的分量的数量.</p>
        <div class="box-links">
        <strong>应用</strong>: 可视化, 提升效率</br>
        <strong>算法</strong>:&nbsp;
    ...
    .. raw:: html
        ...
        <blockquote>
        <p>比较，验证以及选择适用于给定问题的模型及其参数。</p>
        <div class="box-links">
        <strong>目的</strong>: 通过参数调节提升准确率。</br>
        <strong>模块</strong>:&nbsp;
    ...
    .. raw:: html
        ...
        <p>特征抽取以及标准化/归一化.</p>
        <div class="box-links">
        <strong>应用</strong>: 对输入数据比如文本进行变换使其能够用于学习器模型.</br>
        <strong>模块</strong>:&nbsp;
